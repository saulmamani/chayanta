...
CREATE TABLE `carreras` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='utf8mb4_unicode_ci';
...
INSERT INTO `carreras` VALUES (1,'Sistemas Computacionales','Lorem ipsum ut commodo sunt sed voluptate est do in veniam excepteur nisi qui deserunt magna eu dolore qui nulla cillum sint nostrud in nostrud consectetur adipisicing cillum occaecat laborum irure nulla dolore laborum in adipisicing aute exercitation adipisicing in adipisicing occaecat consectetur proident ea adipisicing consequat est anim labore duis aliqua dolore minim ut non aliquip proident ullamco ullamco dolor aute sint laborum dolore qui laborum ex sit in exercitation consequat ea irure qui veniam sit nulla ut elit duis sed enim commodo amet fugiat enim nisi amet do sed magna dolor aute nisi exercitation culpa commodo amet mollit do eiusmod commodo laboris elit sit ut dolor ut veniam ea commodo ullamco commodo aliqua reprehenderit sit eiusmod commodo mollit velit nostrud nisi velit aliqua culpa in adipisicing dolore do mollit est tempor duis reprehenderit minim voluptate amet esse eu fugiat officia exercitation cillum duis in velit dolor et esse mollit aute sit et sit non aliquip reprehenderit tempor reprehenderit.','Tecnico Superior',3,'.../','2018-04-20 04:21:31','2018-05-04 08:25:13',NULL),(2,'Sistemas Informaticos',NULL,'Tecnico',3,NULL,'2018-04-20 04:21:43','2018-04-20 04:22:15','2018-04-20 04:22:15'),(3,'Artesania','Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse.','Tecnico Medio',2,'..','2018-04-20 04:35:18','2018-05-04 08:22:51',NULL),(4,'Agropecuaria','Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse.','Tecnico Medio',2,'..','2018-04-20 04:43:47','2018-05-04 08:23:22',NULL),(5,'Gastronomia',NULL,'Tecnico',3,'..','2018-04-20 04:51:38','2018-04-20 04:54:22','2018-04-20 04:54:22'),(6,'Peinados','Peinados con todo tipo de estilos','Tecnico',1,'foto_saul_2.png','2018-04-20 07:39:23','2018-04-20 07:59:41','2018-04-20 07:59:41'),(7,'Belleza Integral','Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse. Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse.','Tecnico Medio',2,'1524197311_presentacionHackWeb.pdf','2018-04-20 08:08:31','2018-05-04 08:23:59',NULL),(8,'Confeccion Textil','Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse.','Tecnico Medio',2,'1524198841_presentacionHackWeb.pdf','2018-04-20 08:34:01','2018-05-04 08:24:24',NULL),(9,'Tejido Industrial','Reprehenderit aute aliquip irure ut ex sit ut enim magna adipisicing pariatur qui cupidatat et eu proident quis ad est mollit enim commodo consectetur sunt mollit nostrud irure excepteur do officia veniam dolor mollit voluptate esse.','Tecnico Medio',1,'1524270306_presentacionHackWeb.pdf','2018-04-20 08:43:31','2018-05-04 08:25:02',NULL);
...
CREATE TABLE `comunicados` (
  ...
  CONSTRAINT `comunicados_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `documento_bibliograficos` (
  ...
  CONSTRAINT `documento_bibliograficos_facilitadors_id_foreign` FOREIGN KEY (`facilitadors_id`) REFERENCES `facilitadors` (`id`)
...
CREATE TABLE `documento_institucionals` (
  ...
  CONSTRAINT `documento_institucionals_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estudiantes` (
  ...
  CONSTRAINT `estudiantes_carrera_id_foreign` FOREIGN KEY (`carrera_id`) REFERENCES `carreras` (`id`)
...
CREATE TABLE `facilitadors` (
  ...
  CONSTRAINT `facilitadors_carrera_id_foreign` FOREIGN KEY (`carrera_id`) REFERENCES `carreras` (`id`)
...
INSERT INTO `users` VALUES (1,'Saul Mamani','luas0_1@yahoo.es','$2y$10$KarA8MYrks3OZedEuwVT7uFRq.HTnHYXD58AeL7a6RcWa5Rq3Uspu',NULL,'Administrador','E8zOYBsGSsNKOg1RjUDrTMUNpO5zJxKDmP0M2flwYchUbRGSow7KATGvvpyg','2018-04-20 03:30:26','2018-04-20 03:30:26'),(2,'Lidia Tangara Marce','lidia@yahoo.es','$2y$10$Ov9gBalWWyMcuvNtFiwDzueOopLplBm197wAJPDxaeUezCjgSdcSy',NULL,'Secretaria','ApZUbVeqROiVmUQ3lklUQjFxQHTzypJduQMDjNhaRkEQN1QZJ0KePlH8fyx5','2018-04-23 21:30:25','2018-04-23 21:30:25'),(3,'Silvia','silvia@yahoo.es','$2y$10$xoaDSF43hlr3piGurW4GZenzE.xVp.W0uS3OTnYHpNNJO.mtA8kje','secretaria','Secretaria','Z0TxAnnnhzIiPqcz1voWcX7R23JPJYhm0WZon4BKfOR0dcaofWTSm8aEWWME','2018-04-23 22:39:37','2018-04-23 22:39:37'),(4,'Pedro Carrasco','pedro@hotmail.com','$2y$10$GXtZPU5UGTdb00F..YhHx.heH5rsAPqaDVd6KaB14nY1t74SGLJoS','uno','Secretaria',NULL,'2018-04-23 22:41:36','2018-04-23 22:41:36'),(5,'Lara correct','lara@lara.com','$2y$10$DbLtqcL3u7tqlDJ6ZArt6uaGNDAbUZBrxN9CLpKJHopzo7ybJzj7O','sdunld','Secretaria',NULL,'2018-04-23 22:43:55','2018-04-23 22:43:55'),(18,'alsdjflkj jslkjfsl','rda666667','$2y$10$2lIaJp9ha3vrNZr9nrPtp.clyCdxYnsANbtebDm8tamPMIccO/E5O','','Facilitador',NULL,'2018-04-24 02:00:09','2018-04-24 02:00:09'),(20,'Lidia Tangara Marce','rda666661','$2y$10$M6uVNQM76U9aOagbV0mkkuQiqmaJARqFuND6nKo0rn2y3cWNsTTlO','','Facilitador','BfU2dGMKZ7fIabBRiDcB51ftwuukldLvtZsQL8fwM4Lffscd3abZUTnFtpI3','2018-04-29 18:10:07','2018-04-29 18:10:07'),(22,'Jhonny Loayza','666666','$2y$10$m4LqPp4vhcE3y8FyuqFEDeq/CsEGAaEjgC2GEjeXkfur7nZBxN/Ge','','Estudiante','v5o798tIF7mlys5AZpdgcCbOjfcLJ79ej56GVLQz3fqhk06cL8Knd7EPeDSU','2018-04-29 20:56:25','2018-04-29 20:56:25');
...
-- Dump completed on 2018-05-15 10:11:15
